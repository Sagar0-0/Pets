...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    private void savePet() {
        ...
        if(TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString) && TextUtils.isEmpty(weightString) && mGender==PetEntry.GENDER_UNKNOWN){
            Toast.makeText(this, "WTF!! Can't you just enter something first",
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        String petName=data.getString(data.getColumnIndexOrThrow(PetEntry.COLUMN_PET_NAME));
        String breedName=data.getString(data.getColumnIndexOrThrow(PetEntry.COLUMN_PET_BREED));
